                ...
                <form class="form-horizontal" action="{{route('custom.register')}}" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" name="name" placeholder="First Name" value="{{old('fname')}}" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail" class="col-lg-4 control-label">Last Name</label>
                            <div class="col-lg-8">
                                <input class="form-control" name="lastname" placeholder="Last Name" value="{{old('lname')}}" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" id="inputPassword" name="password_confirmation" placeholder="Password" type="password">
                            </div>
                        </div>
