    ...
    public function create()
    {
     ...
     // echo $pid;
        ...
        if($aid=='[{"leadid":'.$id.'}]' || $mid=='[{"Leadid":'.$id.'}]' || $pid=='[{"Leadid":'.$id.'}]')
        {
           ...
           if($servicetype == "Nanny Care" || $servicetype == "Infant Care" || $servicetype == "Neonatal")
         {
...
$nid=DB::table('employees')->where('FirstName',$name)->select('Designation')->get();
        $nid=json_decode($nid);
                     ...
                     return view('verticalheads.mathrutvamedit',compact('mathrutvam','mother','assessment','product','lead','r','leaddata','emp','verc','shift'));
                   }
                   else
                    if($nid=="Management")
                    {
                          return view('management.mathrutvamedit',compact('mathrutvam','mother','assessment','product','lead','r','leaddata','emp','verc','shift'));
                    }
                    else
                   {
                    return view('co.mathrutvamedit',compact('mathrutvam','mother','assessment','product','lead','r','leaddata','emp','verc','shift'));
                   }
        ...
        $nid=json_decode($nid);
                     ...
                     return view('verticalheads.physiotherapyedit',compact('physiotheraphy','lead','physioreport','assessment','product','r','leaddata','emp','verc','shift'));
                   }
                   else
                    if($nid=="Management")
                    {
                          return view('management.physiotherapyedit',compact('physiotheraphy','lead','physioreport','assessment','product','r','leaddata','emp','verc','shift'));
                    }
                    else
                   {
                    return view('co.physiotherapyedit',compact('physiotheraphy','lead','physioreport','assessment','product','r','leaddata','emp','verc','shift'));
                   }
          ...
          if($emid=="Vertical Head")
            {
                     ...
                     return view('verticalheads.mathrutvam',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));

              }
            else
              if($emid=="Management")
                    {
                           return view('management.mathrutvam',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
                    }
              else
            {
                    return view('co.mathrutvam',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
...
if($emid== "Vertical Head")
{
                     ...
                     return view('verticalheads.physiotherapy',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));

      }
      else
        if($emid=="Management")
                    {
                             return view('management.physiotherapy',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
                    }
              else
      {
                     return view('co.physiotherapy',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
...
if($emid=="Vertical Head")
{
         ...
         return view('verticalheads.create',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
        ...
        if($emid=="Management")
                    {
            return view('management.create',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
                    }
        else


      {
              return view('co.create',compact('reference','gender','relation','city','language','gender1','leadtype','condition','vertical','r','leaddata','emp','verc','shift'));
...
if($servicetype == "Nanny Care" || $servicetype == "Infant Care" || $servicetype == "Neonatal")
        {
                ...
                $mother->save();
                  ...
                  $mathruthvam->FeedingMode=$request->FeedingMode;
                  $mathruthvam->MedicalConditions=$request->MedicalConditions;
...
/*
  Code for assessment form 1  started here - by jatin
*/
...
/*
  Code for assessment form 2  started here - by jatin
*/
        ...
        $abdomen=DB::table('abdomens')->max('id');
         ...
         $circulatory=DB::table('circulatories')->max('id');
           ...
           $communication=DB::table('communications')->max('id');
            ...
            $fecal= new fecal;
            $fecal->Continent=$request->Continent;
            $fecal->Incontinent=$request->Incontinent;
           ...
           $visionhearing=DB::table('visionhearings')->max('id');
            ...
            $nutrition->Adequate=$request->Adequate;
            $nutrition->Inadequate=$request->Inadequate;
            $nutrition->Veg=$request->Veg;
            $nutrition->Non_Veg=$request->Non_Veg;
...
/*
  Code for assessment form 3 started here - by jatin
*/
// $log = new Log;
...
if($request->assigned == " ")
{
  ...
  $emp_id = DB::table('employees')->where('FirstName', $logs->name)->value('id');
     ...
     $activity->activity = "The Lead was assigned to ".$request->assigned;
...
else
{
  ...
  $emp_id = DB::table('employees')->where('FirstName', $logs->name)->value('id');
     ...
     $activity = new Activity;
     $activity->emp_id = $emp_id;
     $activity->activity = "The Lead was not assigned to anyone";
     $activity->activity_time = new \DateTime();
     $activity->log_id = $log_id;
     $activity->save();
}
...
// $post1=new Post;
// $columns=$post1->getTableColumns();
//
// // $z = ['title1'=>'title1 value','title2'=>'title2 value'];
//
// // var_dump($post->isDirty('body'));
//
// $d = $post->getDirty();
// $e = $vertical->getDirty();
// dd($e);
...
/*
  Code for assessment form 3 end here - by jatin
*/
