...
<div class="panel panel-default">
      ...
      <div id="collapse12" class="panel-collapse collapse">
        ...
        <label>H_OTB_Asthma_COPD 
        <input type="text" class="form-control" rows="5" name="H_OTB_Asthma_COPD" id="H_OTB_Asthma_COPD" value="@yield('editH_OTB_Asthma_COPD')">
...
<div class="panel panel-default">
      ...
      <div id="collapse6" class="panel-collapse collapse">
        ...
        &emsp;
        <label>H/O POSTTURP<input type="text" class="form-control" rows="5" name="HoPOSTTURP" id="HoPOSTTURP" value="@yield('editHoPOSTTURP')"></label>
        &emsp;
        </div>
        </div>
        </div>
...
<div class="panel panel-default">
      ...
      <div id="collapse19" class="panel-collapse collapse">
       ...
       <label>Weight<input type="text" class="form-control" rows="5" name="Weight" id="Weight" value="@yield('editWeight')"></label>
        ...
        &emsp;
        <label>Mobility <input type="text" class="form-control" rows="5" name="Mobility" id="Mobility" value="@yield('editMobility')"></label>
        &emsp;
        
        <label>Vision <input type="text" class="form-control" rows="5" name="Vision" id="Vision" value="@yield('editVision')"></label>
        &emsp;
        <label>Hearing <input type="text" class="form-control" rows="5" name="Hearing" id="Hearing" value="@yield('editHearing')"></label>
        &emsp;
