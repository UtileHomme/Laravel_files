...
<div class="">
<h1>{{substr(Route::currentRouteName(),20)}} Lead Registration</h1>
<form class="form-horizontal" action="/Verticalhead/@yield('editid')" method="POST">
{{csrf_field()}}
@section('editMethod')
@show
  <fieldset>
...
?>
        ...
        <input type="hidden" class="form-control" rows="5" name="assignedto" id="assignedto" value="<?php echo $assign;?> ">
        &emsp;
...
<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapsed13">Assign Lead To</a>
        </h4>
      </div>
      <div id="collapsed13" class="panel-collapse collapse">
        <div class="panel-body">

              <label>Assign TO
                  <select name="assigned" id="assigned" class="form-control" value="@yield('editassign')">
                  <option value=""></option>
            @foreach($emp as $emp)
