    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <p class="text-muted"><i>by HealthHeal</i></p>
...
<tr data-display="stack{{{$key}}}">
  ...
  <td class="date text-center">{{substr($log['date'],0,10)}}</td>
  <td class="time">{{substr($log['date'],11,9)}}</td>
  <td class="text">
